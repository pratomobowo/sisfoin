...
class UpdateUserRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'fingerprint_pin.min' => 'PIN fingerprint minimal 4 karakter',
            'fingerprint_pin.max' => 'PIN fingerprint maksimal 6 karakter',
    ...
    protected function prepareForValidation(): void
    {
        ...
        // Remove password if empty to avoid updating with null
