<x-guest-layout>
    ...
    <div class="text-center mb-6">
        <h2 class="text-2xl font-semibold text-gray-800 mb-2">Selamat datang kembali</h2>
    ...
    <form method="POST" action="{{ route('login') }}" class="space-y-4">
        ...
        <!-- Email/NIP Address -->
        <div>
            <label for="email" class="block text-sm font-medium text-gray-700 mb-2">Email atau NIP</label>
            <div class="relative">
        ...
        <div>
            ...
            <div class="relative">
                ...
                <input id="password" 
                       ...
                       class="appearance-none block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-xl placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors @error('password') border-red-500 @enderror"
