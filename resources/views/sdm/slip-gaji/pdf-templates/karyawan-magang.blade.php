...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* Border total */
        .border-total {
            border-bottom: 1.2px solid #000000ff;
        }
    </style>
</head>
<body>
    <div class="slip-container">
        ...
        <div class="header">
            ...
            @endif
            <div class="slip-title">SLIP GAJI KARYAWAN MAGANG</div>
                ...
                <tr>
                    <td class="layout-column">
                        ...
                        <table class="salary-table">
                            <tbody>
                                <tr><td>Honor Tetap</td><td class="currency">Rp</td><td class="amount">{{ number_format($detail->honor_tetap ?? 0, 0, ',', '.') }}</td><td class="icon-column"></td></tr>
                                <tr><td>Insentif Golongan</td><td class="currency">Rp</td><td class="amount">{{ number_format($detail->insentif_golongan ?? 0, 0, ',', '.') }}</td><td class="icon-column"></td></tr>
                                ...
                                <tr><td>Transport</td><td class="currency">Rp</td><td class="amount">{{ number_format($detail->transport ?? 0, 0, ',', '.') }}</td><td class="icon-column"></td></tr>
                    ...
                    <td class="layout-column">
                        ...
                        <table class="salary-table">
                            <tbody>
                                ...
                                <tr><td>BPJS Kesehatan</td><td class="currency border-total">Rp</td><td class="amount">{{ number_format($detail->potongan_bpjs_kesehatan ?? 0, 0, ',', '.') }}</td><td class="icon-column"></td></tr>
                                ...
                                <tr class="total-row"><td><strong>Total Potongan</strong></td><td class="currency"><strong>Rp</strong></td><td class="amount"><strong>{{ number_format($detail->total_potongan_tanpa_pajak)}}</strong></td><td class="icon-column"></td></tr>
                            </tbody>
                        </table>
                        <br>
