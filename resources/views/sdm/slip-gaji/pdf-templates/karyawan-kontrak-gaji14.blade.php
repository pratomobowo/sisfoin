...
<head>
    ...
    <title>Slip Gaji 14 - {{ $detail->nama_from_relation }}</title>
    <style>
        @page {
            margin: 12mm 10mm;
            size: A4;
...
<body>
    <div class="slip-container">
        ...
        <div class="header">
            ...
            @endif
            <div class="slip-title">SLIP GAJI 14 - KARYAWAN KONTRAK</div>
                    ...
                    <tr>
                        <td style="width: 50%; vertical-align: top; padding-right: 15px;">
                            <table class="info-table">
                                ...
                                <tr><td>Status Karyawan</td><td>:</td><td>{{ $detail->employee->status_kepegawaian ?? 'Kontrak' }}</td></tr>
                            </table>
                        </td>
        ...
        <table class="salary-table">
            <tbody>
                ...
                <tr><td class="label">2.</td><td class="item-name">Insentif Golongan</td><td class="currency">Rp</td><td class="amount">{{ number_format($detail->insentif_golongan ?? 0, 0, ',', '.') }}</td><td class="symbol"></td><td class="total"></td></tr>
                <tr><td class="label">3.</td><td class="item-name">Transport</td><td class="currency">Rp</td><td class="amount">{{ number_format($detail->transport ?? 0, 0, ',', '.') }}</td><td class="symbol"></td><td class="total"></td></tr>
                <tr><td class="label">4.</td><td class="item-name">Tunjangan PMB</td><td class="currency total-border">Rp</td><td class="amount total-border">{{ number_format($detail->tunjangan_pmb ?? 0, 0, ',', '.') }}</td><td class="symbol">+</td><td class="total"></td></tr>
                ...
                <tr><td class="label">6.</td><td class="item-name">Pajak</td><td class="currency total-border">Rp</td><td class="amount total-border">{{ number_format($detail->pajak ?? 0, 0, ',', '.') }}</td><td class="symbol">-</td><td class="total"></td></tr>
