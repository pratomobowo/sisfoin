...
<body>
    <div class="slip-container">
        <div class="header">
            ...
            @endif
            <div class="slip-title">SLIP GAJI THR - DOSEN DPK</div>
        ...
        <table class="salary-table">
            <tbody>
                ...
                <tr><td class="label">1.</td><td class="item-name">Tunj. Dosen Bantuan Kopertis</td><td class="currency total-border">Rp</td><td class="amount total-border">{{ number_format($detail->tunjangan_pendidikan ?? 0, 0, ',', '.') }}</td><td class="symbol">+</td><td class="total"></td></tr>
