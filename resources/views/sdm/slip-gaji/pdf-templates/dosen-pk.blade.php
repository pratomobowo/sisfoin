...
<body>
    <div class="slip-container">
        ...
        <div class="header">
            ...
            @endif
            <div class="slip-title">SLIP GAJI DOSEN PERJANJIAN KHUSUS</div>
            ...
            <tbody>
                <tr>
                    <td class="layout-column">
                        ...
                        <table class="salary-table">
                            <tbody>
                                <tr><td>Total Honor<br><span class="small-text">(Penerimaan secara tunai)</span></td><td class="currency">Rp</td><td class="amount">{{ number_format($detail->honor_tunai ?? 0, 0, ',', '.') }}</td><td class="icon-column"></td></tr>
                            </tbody>
                        </table>
