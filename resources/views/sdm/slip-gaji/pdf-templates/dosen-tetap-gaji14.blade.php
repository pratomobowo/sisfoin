...
<body>
    <div class="slip-container">
        ...
        <div class="header">
            ...
            @endif
            <div class="slip-title">SLIP GAJI 14 - DOSEN TETAP</div>
        ...
        <table class="salary-table">
            <tbody>
                ...
                <tr><td class="label">3.</td><td class="item-name">Tunjangan Fungsional</td><td class="currency">Rp</td><td class="amount">{{ number_format($detail->tunjangan_fungsional ?? 0, 0, ',', '.') }}</td><td class="symbol"></td><td class="total"></td></tr>
                <tr><td class="label">4.</td><td class="item-name">Tunjangan Golongan</td><td class="currency">Rp</td><td class="amount">{{ number_format($detail->tunjangan_golongan ?? 0, 0, ',', '.') }}</td><td class="symbol"></td><td class="total"></td></tr>
                <tr><td class="label">5.</td><td class="item-name">Tunjangan PMB</td><td class="currency total-border">Rp</td><td class="amount total-border">{{ number_format($detail->tunjangan_pmb ?? 0, 0, ',', '.') }}</td><td class="symbol">+</td><td class="total"></td></tr>
