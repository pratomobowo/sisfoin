...
<body>
    <div class="slip-container">
        ...
        <div class="header">
            ...
            @endif
            <div class="slip-title">SLIP GAJI KARYAWAN TETAP</div>
                    ...
                    <tr>
                        <td style="width: 50%; vertical-align: top; padding-right: 15px;">
                            <table class="info-table">
                                ...
                                <tr><td>Status Karyawan</td><td>:</td><td>{{ $detail->pegawai_data['status_kepegawaian'] ?? $detail->status ?? '-' }}</td></tr>
                            </table>
                        </td>
                        <td style="width: 50%; vertical-align: top; padding-left: 15px;">
                            <table class="info-table">
                                <tr><td>Unit Kerja</td><td>:</td><td>{{ $detail->pegawai_data['satuan_kerja'] ?? '-' }}</td></tr>
                                <tr><td>Jabatan Struktural</td><td>:</td><td>{{ $detail->employee['jabatan_struktural'] ?? '-' }}</td></tr>
                                <tr><td>Golongan</td><td>:</td><td>{{ $detail->pegawai_data['id_pangkat'] ?? '-' }}</td></tr>
                            </table>
                        </td>
                    </tr>
                </tbody>
                    ...
                    <td class="layout-column">
                        ...
                        <table class="salary-table">
                            <tbody>
                                ...
                                <tr><td>Tunjangan Keluarga</td><td class="currency">Rp</td><td class="amount">{{ number_format($detail->tunjangan_keluarga ?? 0, 0, ',', '.') }}</td><td class="icon-column"></td></tr>
                                <tr><td>Tunjangan Kemahalan</td><td class="currency">Rp</td><td class="amount">{{ number_format($detail->tunjangan_kemahalan ?? 0, 0, ',', '.') }}</td><td class="icon-column"></td></tr>
                                <tr><td>Tunjangan Kesehatan</td><td class="currency">Rp</td><td class="amount">{{ number_format($detail->tunjangan_kesehatan ?? 0, 0, ',', '.') }}</td><td class="icon-column"></td></tr>
                                ...
                                <tr><td>Transport</td><td class="currency" style="border-bottom: 1.2px solid #000000ff;">Rp</td><td class="amount" style="border-bottom: 1.2px solid #000000ff;">{{ number_format($detail->transport ?? 0, 0, ',', '.') }}</td><td class="icon-column" style="border-bottom: 1.2px solid #000000ff;"><span class="plus-icon">+</span></td></tr>
